...
class PetsDataset(ClassificationDataset):
    ...
    def __init__(self, fdir: str, subset: Subset):
        ...
        if subset == Subset.TRAINING:
            ...
            raise ValueError("Parameter 'subset' has to be either 'TEST', 'VALIDATION' or 'TRAINING'")
        ...
        # I read in the data in standard Python lists and then convert them into numpy arrays.
        images = []
        labels = []
        for file in files:
